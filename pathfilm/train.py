...
def main():
    ...
    dataset_dir = "/home/cha_ccf/code/CCF_DEEPANC_2026/dataset"
    ...
    model = TimeDomainANC(in_channels=1, out_channels=1, hidden_channels=32, num_layers=10,path_emb_dim=16,path_dropout=0.35,film_scale=0.05).to(device)
