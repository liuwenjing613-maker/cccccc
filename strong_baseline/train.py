...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="E0 reproducible strong baseline for CCF ANC")
    parser.add_argument(
        "--dataset-dir",
        type=str,
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default=os.path.join(script_dir, "outputs_e0"),
    )
